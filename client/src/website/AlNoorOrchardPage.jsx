...
export default function AlNoorOrchardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col font-sans">
      <Helmet>
        <title>Al Noor Orchard Lahore | Hassan Associates</title>
        <meta name="description" content="Embark on a journey of refined living at Al Noor Orchard Lahore, developed by Star Land Marketing. Explore luxury plots, parks, modern infrastructure, and education." />
        <meta name="keywords" content="al noor orchard lahore, al noor orchard, housing society lahore, star land marketing, hassan associates" />
      </Helmet>
      ...
      <section className="relative w-full h-[250px] sm:h-[350px] md:h-[400px] bg-slate-950">
        <div
          ...
          style={{ backgroundImage: "url('/assets/al-nooor.jpg')" }}
        />
            ...
            <div className="lg:col-span-8 flex flex-col gap-10 text-left">
              ...
              <div className="flex flex-col gap-4">
                <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-950 border-b pb-3 border-slate-100">
                  About Al Noor Orchard
                </h2>
                <div className="text-slate-600 text-sm sm:text-base leading-relaxed flex flex-col gap-4 font-normal">
                  <p>
                    Embark on a journey of refined living at <strong>Al Noor Orchard,</strong> an exquisite development by <strong>Star Land Marketing</strong>. Our carefully planned community offers a perfect fusion of contemporary amenities, lush green spaces, and a thriving communal ambiance. Experience a lifestyle where luxury meets comfort, and each corner radiates architectural excellence.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full overflow-hidden shadow-lg border border-slate-100 rounded-sm">
                <img
                  src="/assets/al-nooor.jpg"
                  alt="Al Noor Orchard Showcase"
                ...
                <div className="columns-1 sm:columns-2 md:columns-3 gap-6">
                  {galleryImages.map((src, index) => (
                    ...
                    >
                      <img
                        src={src}
                        alt={`Al Noor Orchard view ${index + 1}`}
              ...
              <div className="flex flex-col gap-6">
                <h3 className="text-xl sm:text-2xl font-bold text-[#cca328]">
                  Key Features of Al Noor Orchard
                </h3>
                <hr className="border-t border-slate-200 w-full" />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-12 max-w-2xl">
                  ...
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Gated Community & Security</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                  ...
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Modern Commercial Areas</span>
                  </div>
                </div>
              </div>
