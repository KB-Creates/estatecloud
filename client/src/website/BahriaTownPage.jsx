...
export default function BahriaTownPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col font-sans">
      <Helmet>
        <title>Bahria Town Lahore | Hassan Associates</title>
        <meta name="description" content="Explore Bahria Town Lahore, a master-planned community offering world-class infrastructure, educational facilities, luxury plots, and modern healthcare." />
        <meta name="keywords" content="bahria town lahore, housing society lahore, bahria town, grand jamia mosque lahore, hassan associates" />
      </Helmet>
      ...
      <section className="relative w-full h-[250px] sm:h-[350px] md:h-[400px] bg-slate-950">
        <div
          ...
          style={{ backgroundImage: "url('/assets/bahriatown.jpg')" }}
        />
            ...
            <div className="lg:col-span-8 flex flex-col gap-10 text-left">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="text-slate-600 text-sm sm:text-base leading-relaxed flex flex-col gap-4 font-normal">
                  <p>
                    Welcome to <strong>Bahria Town Lahore,</strong> a master-planned community that redefines luxurious living in Pakistan. Developed by the renowned <strong>Bahria Town</strong> Pvt. Ltd., this sprawling township offers a harmonious blend of modern amenities, green spaces, and a vibrant community atmosphere. Discover a lifestyle where comfort meets sophistication, and every corner reflects the epitome of architectural brilliance.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full overflow-hidden shadow-lg border border-slate-100 rounded-sm">
                <img
                  src="/assets/bahriatown.jpg"
                  alt="Bahria Town Showcase"
              ...
              <div className="flex flex-col gap-6">
                <h3 className="text-xl sm:text-2xl font-bold text-[#cca328]">
                  Key Features of Bahria Town Lahore
                </h3>
                <hr className="border-t border-slate-200 w-full" />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-12 max-w-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-800 font-medium text-base">World-Class Infrastructure</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Educational Facilities</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Premium Residential Plots</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Healthcare Services</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                  ...
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Community Living</span>
                  </div>
                </div>
              </div>
