...
export default function LahoreMeadowsCityPage() {
  ...
  const galleryImages = [
    "/assets/medow.jpg",
    "/assets/lahore-medow.jpg",
    "/assets/smart_city.png",
    "/assets/final.jpg",
    "/assets/banner3.jpg",
  ]
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col font-sans">
      <Helmet>
        <title>Lahore Meadows City | Hassan Associates</title>
        <meta name="description" content="Discover Lahore Meadows City, an LDA-approved housing society in Lahore offering scenic ambiance, commercial hubs, modern infrastructure, and security." />
        <meta name="keywords" content="lahore meadows city, housing society lahore, lda approved plots, lahore meadows, hassan associates" />
      </Helmet>
      ...
      <section className="relative w-full h-[250px] sm:h-[350px] md:h-[400px] bg-slate-950">
        <div
          ...
          style={{ backgroundImage: "url('/assets/lahore-medow.jpg')" }}
        />
            ...
            <div className="lg:col-span-8 flex flex-col gap-10 text-left">
              ...
              <div className="flex flex-col gap-4">
                <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-950 border-b pb-3 border-slate-100">
                  About Lahore Meadows City
                </h2>
                <div className="text-slate-600 text-sm sm:text-base leading-relaxed flex flex-col gap-4 font-normal">
                  <p>
                    Discover the epitome of modern living at <strong>Lahore Meadows City,</strong> an LDA-approved residential haven meticulously crafted for a harmonious lifestyle. This vibrant community offers a perfect fusion of contemporary design and urban conveniences, promising residents an unmatched experience in comfort and connectivity. Embrace a new standard of living at <strong>Lahore Meadows City,</strong> where every detail reflects the vision of a thriving and dynamic community.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full overflow-hidden shadow-lg border border-slate-100 rounded-sm">
                <img
                  src="/assets/medow.jpg"
                  alt="Lahore Meadows City Showcase"
                ...
                <div className="columns-1 sm:columns-2 md:columns-3 gap-6">
                  {galleryImages.map((src, index) => (
                    ...
                    >
                      <img
                        src={src}
                        alt={`Lahore Meadows City view ${index + 1}`}
              ...
              <div className="flex flex-col gap-6">
                <h3 className="text-xl sm:text-2xl font-bold text-[#cca328]">
                  Key Features of Lahore Meadows City
                </h3>
                <hr className="border-t border-slate-200 w-full" />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-12 max-w-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-800 font-medium text-base">LDA Approved Project</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Strategic Location</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Scenic Ambiance</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">State-of-the-Art Amenities</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Eco-Friendly Environment</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Commercial Hubs</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Gated Secure Community</span>
                  </div>
                </div>
              </div>
