...
export default function ParkViewCityPage() {
  ...
  const galleryImages = [
    "/assets/parkview_1.jpg",
    "/assets/parkview_2.jpg",
    "/assets/parkview_3.jpg",
    "/assets/parkview_4.jpg",
    "/assets/parkview_5.jpg",
    "/assets/parkview_6.jpg",
    "/assets/parkview_7.jpg",
  ]
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col font-sans">
      <Helmet>
        <title>Park View City Lahore | Hassan Associates</title>
        <meta name="description" content="Explore Park View City Lahore, a premium residential society featuring modern infrastructure, safety, parks, and world-class amenities." />
        <meta name="keywords" content="park view city lahore, housing society lahore, residential plots lahore, park view city, hassan associates" />
      </Helmet>
      ...
      <section className="relative w-full h-[250px] sm:h-[350px] md:h-[400px] bg-slate-950">
        <div
          ...
          style={{ backgroundImage: "url('/assets/park-view-city.jpg')" }}
        />
            ...
            <div className="lg:col-span-8 flex flex-col gap-10 text-left">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="text-slate-600 text-sm sm:text-base leading-relaxed flex flex-col gap-4 font-normal">
                  <p>
                    <strong>Park View City Lahore</strong> is a residential society situated on the most accessible point of Lahore. The housing scheme that was originally developed on 765 kanals of land has now been extended to more than 10,000 kanals.
                  </p>
                  <p>
                    Further plans to extend the project to 31,000 kanals are now underway. This includes residential plots ranging from 5 marlas to 1 kanal, and commercial plots from 4 marlas to 8 marlas. The land will include state-of-the-art infrastructure and vital amenities like roads, water, sewers, electric, gas, parks, mosques, schools, graveyards, commercial plazas, community centers, health clubs, and even a mini zoo. 
                  </p>
                  <p>
                    <strong>Park View City Lahore</strong> prides itself on providing a safe and secure environment for its residents and has 24/7 security posted and patrolling all over the society.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full overflow-hidden shadow-lg border border-slate-100 rounded-sm">
                <img
                  src="/assets/park-view-city.jpg"
                  alt="Park View City Showcase"
                ...
                <div className="columns-1 sm:columns-2 md:columns-3 gap-6">
                  {galleryImages.map((src, index) => (
                    ...
                    >
                      <img
                        src={src}
                        alt={`Park View City view ${index + 1}`}
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-12 max-w-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-800 font-medium text-base">Underground Electricity</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">School</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Parks</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Zoo</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Easy Access</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-[#cca328] shrink-0" />
                    <span className="text-slate-800 font-medium text-base">Security</span>
                  </div>
                </div>
              </div>
