...
export default function Header() {
  ...
  return (
    <header className="relative w-full bg-white/95 border-b border-slate-200/80 shadow-xs bg-[url('/templete%20images/grid-top-scaled.webp')] bg-top bg-no-repeat bg-cover">
